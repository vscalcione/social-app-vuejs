...
export default {
  ...
  SIGN_UP: ({ dispatch, commit }, formNewUser) =>
    new Promise((resolve, reject) => {
      commit("SET_LOADING", { name: "form", value: true });
  ...
  EDIT_USER_DETAILS: ({ dispatch, commit }, userDetails) =>
  ...
  POST_NEW_SCREAM: ({ commit }, newScream) =>
  ...
  // COMMENT IN SCREAM
  SUBMIT_COMMENT: ({ commit }, commentData) =>
    new Promise((response, reject) => {
      commit("SET_LOADING", { name: "form", value: true });
